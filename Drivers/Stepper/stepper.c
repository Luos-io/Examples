 ...
 * Function
 ******************************************************************************/
static void Stepper_MsgHandler(module_t *module, msg_t *msg);
...
{
    Luos_ModuleEnableRT(Luos_CreateModule(Stepper_MsgHandler, STEPPER_MOD, "stepper_mod", STRINGIFY(VERSION)));
